...
export const sendVerificationEmail = async (email, name, token) => {
  ...
  await resend.emails.send({
    ...
    to:      email,
    subject: 'Verify your ScaleGPT account',
    html: `
      <div style="font-family:'Outfit',sans-serif;background:#06060e;color:#f0f0ff;padding:40px;border-radius:16px;max-width:480px;margin:auto;">
        ...
        <p style="color:#f0f0ff;margin-bottom:20px;">Click the button below to verify your email address.</p>
        <a href="${link}" style="display:inline-block;padding:12px 28px;background:linear-gradient(135deg,#7b5ea7,#f067a6);color:#fff;border-radius:10px;text-decoration:none;font-weight:700;font-size:14px;">Verify Email →</a>
        <p style="color:#5a5a7a;font-size:11px;margin-top:24px;">This link expires in 24 hours. If you didn't create an account, ignore this email.</p>
      </div>
    `,
  });
};
